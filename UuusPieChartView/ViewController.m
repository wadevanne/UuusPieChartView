...
- (void)viewDidLoad {
    ...
    UuusPieChartItem *redItem = [UuusPieChartItem itemWithValue:10 color:[UIColor redColor] summary:nil];
    UuusPieChartItem *orangeItem = [UuusPieChartItem itemWithValue:20 color:[UIColor orangeColor] summary:nil];
    UuusPieChartItem *brownItem = [UuusPieChartItem itemWithValue:30 color:[UIColor brownColor] summary:nil];
    UuusPieChartItem *greenItem = [UuusPieChartItem itemWithValue:40 color:[UIColor greenColor] summary:nil];
    ...
    for (long i = 0; i < model.count / 2 + model.count % 2; ++i) {
        for (long j = 0; j < 2; ++j) {
            ...
            label.tag = j + i * 2;
            label.text = [NSString stringWithFormat:@"%f", model.itemsArray[label.tag].ratio];
